...
**Source → https://github.com/baditaflorin/mesh-sound-guess**
...
git clone https://github.com/baditaflorin/mesh-sound-guess
cd mesh-sound-guess
npm install
npm run dev
```
...
- `mesh-sound-guess:signalingUrl`
- `mesh-sound-guess:turnTokenUrl`
- `mesh-sound-guess:iceServers`
- `mesh-sound-guess:room`
...
Start a clue and everyone in the room receives the same emoji and readable prompt.
Players submit text guesses; correct guesses are marked in the shared, screen-reader-friendly log.
The app uses no microphone permission, does not record audio, and has no app backend.
